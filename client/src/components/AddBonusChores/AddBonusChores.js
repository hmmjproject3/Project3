            ...
            <TableBody>
              ...
              {editing["2"] ?
                <TableRow key='row.name'>
                  ...
                  <TableCell style={{ paddingRight: '5px', paddingLeft: '5px' }}>
                    <Fab onClick={() => toggleEdit("2")} color="secondary" aria-label="Edit" className={classes.editBtn}>
                      <Icon className={classes.editIcon}>edit_icon</Icon>
                    </Fab>
                  </TableCell>
                  <TableCell style={{ paddingLeft: '5px', paddingRight: '20px' }}>
              ...
              {editing["3"] ?
                <TableRow key='row.name'>
                  ...
                  <TableCell style={{ paddingRight: '5px', paddingLeft: '5px' }}>
                    <Fab onClick={() => toggleEdit("3")} color="secondary" aria-label="Edit" className={classes.editBtn}>
                      <Icon className={classes.editIcon}>edit_icon</Icon>
                    </Fab>
                  </TableCell>
                  <TableCell style={{ paddingLeft: '5px', paddingRight: '20px' }}>
              ...
              {editing["4"] ?
                <TableRow key='row.name'>
                  ...
                  <TableCell style={{ paddingRight: '5px', paddingLeft: '5px' }}>
                    <Fab onClick={() => toggleEdit("4")} color="secondary" aria-label="Edit" className={classes.editBtn}>
                      <Icon className={classes.editIcon}>edit_icon</Icon>
                    </Fab>
                  </TableCell>
                  <TableCell style={{ paddingLeft: '5px', paddingRight: '20px' }}>
